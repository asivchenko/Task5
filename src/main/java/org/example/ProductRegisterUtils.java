...
@Service
public class ProductRegisterUtils {
    @Autowired
    ...
    public Optional<org.example.entity.TppRefProductRegisterTypeEntity> getType(String registryTypeCode)
    {
    ...
    public org.example.entity.AccountEntity getAccount(String branchCode, String currencyCode, String mdmCode, String priorityCode,
